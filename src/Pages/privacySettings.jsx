        ...
        <div className='flex flex-col flex-1 gap-[32px]'>
          <div className='flex flex-col md:flex-row flex-1 gap-2 md:gap-0'>
            ...
            <div className='ml-auto'>
              <button type='button' className={`${typography.labelSmall} btx flex flex-row gap-[12px] items-center justify-center p-[10px] ml-auto bg-bg-white-0 border-stroke-soft-200 border-[1px]  rounded-[10px] h-[38px] max-w-[160px] text-text-sub-500 `}>
                Change Password
              </button> 
            </div>
          </div>
          ...
          <div className='flex flex-col md:flex-row flex-1 gap-2 md:gap-0'>
            ...
            <div className='ml-auto'>
              <button type='button' className={`${typography.labelSmall} btx flex flex-row gap-[12px] items-center justify-center p-[10px] ml-auto bg-bg-white-0 border-stroke-soft-200 border-[1px]  rounded-[10px] h-[38px] max-w-[195px] text-text-sub-500 `}>
          ...
          <div className='flex flex-col md:flex-row flex-1 gap-2 md:gap-0'>
            ...
            <div className='ml-auto'>
              <button type='button' className={`${typography.labelSmall} slogoutbtn flex flex-row gap-[12px] items-center justify-center p-[10px] ml-auto bg-bg-white-0 border-redBase border-[1px]  rounded-[10px] h-[38px] max-w-[195px] text-redBase `}>
