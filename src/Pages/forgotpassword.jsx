        ...
        <div className=' h-[100%] flex flex-col w-96 gap-[8px]' >
            ...
            <div className='h-[100%]'>
                ...
                <form onSubmit={handleSubmit} className=' flex flex-col '>
                    ...
                    <button type='submit' className=' flex justify-center mt-auto bg-primaryPurple600 text-text-white-0 rounded-full h-14 items-center '><a href='/changepassword'>Send OTP</a></button>
